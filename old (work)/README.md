...
* **Numpad \*** - Disable/enable all binds (only exit key still works)
* **Numpad -** - Exit script
...
* **Bind lock indicator**: When all binds are disabled via `Numpad *`, status text and indicator dot turn yellow
